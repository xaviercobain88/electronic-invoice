...
public class InvoiceHeader implements Serializable {
	...
	public ElectronicInvoice addElectronicInvoice(ElectronicInvoice electronicInvoice) {
	...
	public ElectronicInvoice removeElectronicInvoice(ElectronicInvoice electronicInvoice) {
