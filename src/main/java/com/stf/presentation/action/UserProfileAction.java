...
@URLMappings(mappings = {
		...
		@URLMapping(id = "newUserProfile1", pattern = "/public/new-user/", viewId = "/pages/user-profile.jsf"),
		@URLMapping(id = "newUserProfile2", pattern = "/public/new-user", viewId = "/pages/user-profile.jsf") })
public class UserProfileAction extends BaseController {
	@EJB
	 ...
	 */
	@URLActions(actions = {
			@URLAction(onPostback = false, mappingId = "editUserProfile1"),
			@URLAction(onPostback = false, mappingId = "editUserProfile2") })
	@Interceptors(Guard.class)
	@AllowedPermission(permissionNameEnum = PermissionNameEnum.USER_PROFILE, pageInformationEnum = PageInformationEnum.OWNER)
	public String initWithAuthorization() {
	 ...
	 */
	@URLActions(actions = {
			@URLAction(onPostback = false, mappingId = "newUserProfile1"),
			@URLAction(onPostback = false, mappingId = "newUserProfile2") })
	// @Interceptors(Guard.class)
	@AllowedPermission(permissionNameEnum = PermissionNameEnum.USER_PROFILE, pageInformationEnum = PageInformationEnum.NEW)
	public String initWithoutAuthorization() {
	 ...
	 * @return
	 */
	public String generalInitialization() {
		try {
