...
public class ObjectFactory {
    ...
    private final static QName _AutorizacionComprobanteLoteMasivo_QNAME = new QName("http://ec.gob.sri.ws.autorizacion", "autorizacionComprobanteLoteMasivo");
    private final static QName _Autorizacion_QNAME = new QName("http://ec.gob.sri.ws.autorizacion", "autorizacion");
    private final static QName _AutorizacionComprobanteLoteMasivoResponse_QNAME = new QName("http://ec.gob.sri.ws.autorizacion", "autorizacionComprobanteLoteMasivoResponse");
    ...
    /**
     * Create an instance of {@link AutorizacionComprobanteLoteMasivoResponse }
     * 
     */
    public AutorizacionComprobanteLoteMasivoResponse createAutorizacionComprobanteLoteMasivoResponse() {
        return new AutorizacionComprobanteLoteMasivoResponse();
    }

    /**
     * Create an instance of {@link AutorizacionComprobanteLoteMasivo }
     * 
     */
    public AutorizacionComprobanteLoteMasivo createAutorizacionComprobanteLoteMasivo() {
        return new AutorizacionComprobanteLoteMasivo();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link AutorizacionComprobanteLoteMasivo }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ec.gob.sri.ws.autorizacion", name = "autorizacionComprobanteLoteMasivo")
    public JAXBElement<AutorizacionComprobanteLoteMasivo> createAutorizacionComprobanteLoteMasivo(AutorizacionComprobanteLoteMasivo value) {
        return new JAXBElement<AutorizacionComprobanteLoteMasivo>(_AutorizacionComprobanteLoteMasivo_QNAME, AutorizacionComprobanteLoteMasivo.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link AutorizacionComprobanteLoteMasivoResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ec.gob.sri.ws.autorizacion", name = "autorizacionComprobanteLoteMasivoResponse")
    public JAXBElement<AutorizacionComprobanteLoteMasivoResponse> createAutorizacionComprobanteLoteMasivoResponse(AutorizacionComprobanteLoteMasivoResponse value) {
        return new JAXBElement<AutorizacionComprobanteLoteMasivoResponse>(_AutorizacionComprobanteLoteMasivoResponse_QNAME, AutorizacionComprobanteLoteMasivoResponse.class, null, value);
    }
