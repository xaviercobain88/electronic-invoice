...
public interface AutorizacionComprobantes {
     ...
     */
    @WebMethod
    @WebResult(name = "RespuestaAutorizacionLoteMasivo", targetNamespace = "")
    @RequestWrapper(localName = "autorizacionComprobanteLoteMasivo", targetNamespace = "http://ec.gob.sri.ws.autorizacion", className = "autorizacion.ws.sri.gob.ec.AutorizacionComprobanteLoteMasivo")
    @ResponseWrapper(localName = "autorizacionComprobanteLoteMasivoResponse", targetNamespace = "http://ec.gob.sri.ws.autorizacion", className = "autorizacion.ws.sri.gob.ec.AutorizacionComprobanteLoteMasivoResponse")
    public RespuestaLote autorizacionComprobanteLoteMasivo(
